...
export default function FormSection() {
    ...
    const selected_issue = product_registration?.common_issues?.filter(res => {
                ...
                <div className=' flex flex-col gap-3 my-5'>
                    {
                        call_type === 'safety_issue' && (
                            <>
                                ...
                                <>
                                    <Checkbox
                                        name="has_attempted_return"
                                        label="Yes, I’ve already tried to return it"
                                        checked={watchValues.has_attempted_return}
                                        onChange={(val) =>
                                            setValue("has_attempted_return", val.target.checked)
                                        }
                                    />

                                    {watchValues.has_attempted_return && (
                                        <Textarea
                                            name="return_attempt_reason"
                                            label="State the reason"
                                            {...register("return_attempt_reason", { required: "Reason is required" })}
                                            error={errors.return_attempt_reason?.message}
                                        />
                                    )}
                                </>
                            </>

...
<body>
    <div class="wrapper">
        <div class="card">
            <div class="header">
                <h1>Warranty Claim Received 🛠️</h1>
            </div>
            <div class="content">
                <p>Hi <strong>{{ $ticket->fname??'' }}</strong>,</p>
                <p>Thank you for reaching out to <strong>Curtis International Ltd.</strong> We have successfully received your warranty claim request.</p>
                ...
                <div class="claim-details">
                    <p style="margin-top: 0;"><strong>Your Claim Summary:</strong></p>
                    <ul>
